...
while True :
    ...
    if ch == "1":
        ...
        os.system("vgcreate {} /dev/{} /dev/{}".format(vgn,pv1))
        ...
        fol = input("enter name for your folder : ")
        os.system("mkdir /{}".format(fol))
        print("mounting your lv {} to the /{} folder".format(lvname,fol))
        os.system("mount /dev/{}/{}  /{}".format(vgn,lvname,fol))
